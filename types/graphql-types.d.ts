...
export type Unnamed_2_Query = { allFile: { nodes: Array<(
      Pick<File, 'relativePath'>
      & { childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_NoBase64Fragment> }> }
    )> } };
...
export type Unnamed_3_Query = { microcmsPosts?: Maybe<(
